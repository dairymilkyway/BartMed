...
@section('content')
<main class="flex justify-center items-center min-h-screen py-1 md:w-2/3 lg:w-3/4">
    <div class="w-full">
        <div class="max-w-2xl mx-auto px-6 pb-8 mt-8 sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 gap-6 mt-8">
                ...
                <div class="mt-8 sm:mt-14 text-[#202142]">
                    ...
                    <div
                        class="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-4 sm:mb-6">
                        <div class="w-full">
